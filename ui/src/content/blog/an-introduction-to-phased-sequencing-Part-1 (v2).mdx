---
title: "An Introduction to Phased Sequencing: Part 1 (v2)"
...
<h3 id="why-whole-molecule-rna-measurement-matters">Why does whole-molecule RNA measurement matter?</h3>
...
<h3 id="rna-as-molecular-phenotype">RNA as molecular phenotype</h3>
...
<h3 id="how-pseq-compares-with-other-rna-technologies">How does PSeq compare with other RNA technologies?</h3>
...
<ArticleComparisonTable
  ariaLabel="Comparison of RNA-Seq, long-read sequencing, and PSeq"
  rowHeaderLabel="Characteristic"
  columns={[
    { key: 'pseq', label: 'PSeq', highlighted: true },
    { key: 'rnaSeq', label: 'RNA-Seq' },
    { key: 'longReadSeq', label: '3rd Gen Long Read Seq', shortLabel: 'Long-read sequencing' },
  ]}
  rows={[
    {
      label: 'Instrument compatibility',
      values: {
...
<h3 id="pseq-vs-rna-seq">PSeq vs. RNA-Seq</h3>
...
<h3 id="how-pseq-accomplishes-whole-molecule-resolution">How does PSeq accomplish whole-molecule resolution?</h3>
...
<h3 id="pseq-returns-more-information-than-rna-seq">PSeq returns more information than RNA-Seq</h3>

Consider three examples:

<ArticleExampleList
  ariaLabel="Examples comparing RNA-Seq and PSeq"
  items={[
    {
...
<h3 id="why-molecule-resolved-rna-data-matter-for-machine-learning">Why molecule-resolved RNA data matter for machine learning</h3>
...
<h3 id="gene-counts-vs-isoforms">Gene counts tell us who is speaking. Isoforms tell us what is being said.</h3>
