...
- Production database: Supabase project `phaeno-website`
...
```bash
./migrate --connection "SUPABASE_NPGSQL_CONNECTION_STRING"
```
...
At minimum, use Supabase backups or manual `pg_dump` exports before risky schema
